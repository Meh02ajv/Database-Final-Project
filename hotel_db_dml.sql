...
('Deluxe',      'Spacious room with king bed, premium furnishings, mini-bar, and city view.',                       150.00),
...
--    BookingReference format: GH-YYYYMMDD-NNNNN
--    Statuses: mix of Confirmed, Checked-In, Checked-Out, Cancelled
-- =============================================================================
...
-- =============================================================================
-- 7. INVOICE (25 records — one per reservation + one per event booking)
--    TotalAmount = RoomCharges + EventCharges + AdditionalCharges
--    Room charges = PricePerNight × nights
--    Event charges = BookingPricePerHour × hours
-- =============================================================================
INSERT INTO INVOICE
...
(1,  NULL, 240.00,    0.00,   0.00, 240.00,  'Paid',           '2026-05-01 14:30:00'),  -- 3 nights × $80
(2,  NULL, 1200.00,   0.00,   0.00, 1200.00, 'Paid',           '2026-05-05 15:00:00'),  -- 4 nights × $300
(3,  NULL, 160.00,    0.00,   0.00, 160.00,  'Paid',           '2026-05-10 14:15:00'),  -- 2 nights × $80
(4,  NULL, 360.00,    0.00,  50.00, 410.00,  'Paid',           '2026-05-15 14:00:00'),  -- 3 nights × $120 + late fee
(5,  NULL, 300.00,    0.00,   0.00, 300.00,  'Paid',           '2026-05-20 15:30:00'),  -- 2 nights × $150
(6,  NULL, 160.00,    0.00,   0.00, 160.00,  'Paid',           '2026-06-01 14:00:00'),  -- 2 nights × $80
(7,  NULL, 750.00,    0.00,   0.00, 750.00,  'Paid',           '2026-06-05 14:45:00'),  -- 5 nights × $150
(8,  NULL, 300.00,    0.00,   0.00, 300.00,  'Paid',           '2026-06-12 14:00:00'),  -- 2 nights × $150
(9,  NULL, 360.00,    0.00,  30.00, 390.00,  'Paid',           '2026-06-18 15:00:00'),  -- 3 nights × $120 + late fee
(10, NULL, 160.00,    0.00,   0.00, 160.00,  'Paid',           '2026-07-01 14:00:00'),  -- 2 nights × $80
 
-- Reservation invoices (Checked-In → Unpaid)
(11, NULL, 600.00,    0.00,   0.00, 600.00,  'Unpaid',         '2026-08-06 14:30:00'),  -- 4 nights × $150
(12, NULL, 300.00,    0.00,   0.00, 300.00,  'Unpaid',         '2026-08-07 15:00:00'),  -- 2 nights × $150
(13, NULL, 600.00,    0.00,   0.00, 600.00,  'Unpaid',         '2026-08-07 14:00:00'),  -- 5 nights × $120
(14, NULL, 240.00,    0.00,   0.00, 240.00,  'Unpaid',         '2026-08-08 14:15:00'),  -- 3 nights × $80
(15, NULL, 750.00,    0.00,   0.00, 750.00,  'Unpaid',         '2026-08-08 15:30:00'),  -- 5 nights × $150
 
-- Reservation invoices (Confirmed → Unpaid)
(16, NULL, 480.00,    0.00,   0.00, 480.00,  'Unpaid',         '2026-08-10 00:00:00'),  -- 4 nights × $120
(17, NULL, 160.00,    0.00,   0.00, 160.00,  'Unpaid',         '2026-08-11 00:00:00'),  -- 2 nights × $80
(18, NULL, 480.00,    0.00,   0.00, 480.00,  'Unpaid',         '2026-08-12 00:00:00'),  -- 4 nights × $120
(19, NULL, 240.00,    0.00,   0.00, 240.00,  'Unpaid',         '2026-08-14 00:00:00'),  -- 3 nights × $80
(20, NULL, 1500.00,   0.00,   0.00, 1500.00, 'Unpaid',         '2026-08-15 00:00:00'),  -- 5 nights × $300
 
-- Event invoices (Completed → Paid)
(NULL, 1,  0.00, 3500.00,   0.00, 3500.00, 'Paid',            '2026-05-03 16:00:00'),  -- 7 hrs × $500
(NULL, 2,  0.00,  640.00,   0.00,  640.00, 'Paid',            '2026-05-08 09:00:00'),  -- 8 hrs × $80
(NULL, 3,  0.00,  120.00,   0.00,  120.00, 'Paid',            '2026-05-15 10:00:00'),  -- 2 hrs × $60
(NULL, 4,  0.00,  800.00,   0.00,  800.00, 'Paid',            '2026-05-25 18:00:00'),  -- 4 hrs × $200
(NULL, 5,  0.00,  400.00,   0.00,  400.00, 'Paid',            '2026-06-02 09:00:00');  -- 4 hrs × $100
 
 
-- =============================================================================
-- 8. FEEDBACK (20 records — only for Checked-Out reservations and Completed events)
-- =============================================================================
...
-- Run these after executing the script to confirm record counts.
-- =============================================================================
 
SELECT 'ROOM_CATEGORY'  AS Entity, COUNT(*) AS RecordCount FROM ROOM_CATEGORY
UNION ALL
...
SELECT
    SUM(RoomCharges)       AS TotalRoomRevenue,
    SUM(EventCharges)      AS TotalEventRevenue,
    SUM(AdditionalCharges) AS TotalAdditionalRevenue,
    SUM(TotalAmount)       AS GrandTotalRevenue
FROM   INVOICE
WHERE  PaymentStatus = 'Paid';
 
-- Average feedback rating per type
SELECT
    CASE
        WHEN ReservationID IS NOT NULL THEN 'Room Stay'
        ELSE 'Event'
    END                  AS FeedbackType,
